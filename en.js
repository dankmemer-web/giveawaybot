...
module.exports = {
    ...
    start: {
      ...
      channel: ":warning: Please enter the channel to start the giveaway in.",
      ...
      prize: ":warning: Please indicate the prize. Example `nitro`.",
      good: ":tada: I launched the giveaway in :",
